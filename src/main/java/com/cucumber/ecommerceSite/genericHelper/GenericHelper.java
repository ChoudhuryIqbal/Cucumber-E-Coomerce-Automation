package com.cucumber.ecommerceSite.genericHelper;
...
public class GenericHelper extends com.cucumber.ecommerceSite.TestBase.TestBase{
	
	private static final Logger log = com.cucumber.ecommerce.helper.logger.LoggerHelper.getLogger(GenericHelper.class);
